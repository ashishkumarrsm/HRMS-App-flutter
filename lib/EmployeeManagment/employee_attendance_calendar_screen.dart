...
class _EmployeeAttendanceCalendarScreenState
  ...
  // * ======= defaule or current date
  DateTime _focusedDay = DateTime.now();
  // * =========== Selected date or click on any date
          ...
          children: [
            Expanded(
              child: TableCalendar(
                ...
                // * --------- Remove the 2 week section ---------
                availableCalendarFormats: const {CalendarFormat.month: 'Month'},
                // * -------- Select the CalendarFormat ----------
                ...
                headerStyle: HeaderStyle(
                  ...
                  leftChevronIcon: Image.asset(
                    "assets/images/Previous Month Button.png",
                    width: 24,
                    height: 24,
                    color: Color(0xff1F2937),
                  ),
                  leftChevronMargin: EdgeInsets.only(right: 16),
                  // * -------- right side button ---------
                  rightChevronIcon: Image.asset(
                    "assets/images/Next Month Icon.png",
                    width: 24,
                    height: 24,
                    color: Color(0xff1F2937),
                  ),
                  rightChevronMargin: EdgeInsets.only(left: 16),
                ),
