...
import 'package:hrms/Complaint/complaint_Details.dart';
import 'Data/complaint_Data.dart';

class ComplaintTabPage extends StatefulWidget {
  const ComplaintTabPage({super.key});

  @override
  State<ComplaintTabPage> createState() => _ComplaintTabPageState();
}

class _ComplaintTabPageState extends State<ComplaintTabPage>
...
class OvertimeListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final filteredList = complaintList
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  ComplaintDetails(complaint: widget.complaint),
            ),
          );
        },
        child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: widget.complaint.status == "Pending"
                            ? Color(0xFFFEF9C3)
                            : widget.complaint.status == "Approved"
                            ? Color(0xFFDCFCE7)
